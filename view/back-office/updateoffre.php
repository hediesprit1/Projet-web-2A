        ...
        <div class="page-inner">
            ...
            <div class="card card-round">
              <div class="card-header">
                <div class="card-head-row card-tools-still-right">
                  <div class="card-title">Modifier un offre</div>
                </div>
              </div>
            </div>
          </div>
          <script>
            document.addEventListener("DOMContentLoaded", function() {
              ...
              form.addEventListener("submit", function(e) {
                let idVehicule = document.getElementById("id_vehicule");
                ...
                if (idVehicule.value.trim() === "") {
                  document.getElementById("vehiculeError").textContent = "ID Véhicule requis.";
                  valid = false;
                } else {
                  document.getElementById("vehiculeError").textContent = "";
                }

                if (prix.value.trim() === "" || isNaN(prix.value)) {
                  document.getElementById("prixError").textContent = "Prix valide requis.";
                  valid = false;
                } else {
          ...
          <form id="offreForm" method="post">
            <div class="mb-3">
              ...
              <input type="number" class="form-control" id="id_vehicule" name="id_vehicule" value="<?= $offre['id_vehicule'] ?>">
              <span id="vehiculeError" style="color:red;"></span>
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="prix" value="<?= $offre['prix'] ?>" name="prix">
              <span id="prixError" style="color:red;"></span>
            </div>
            <a href="offres.php" class="btn btn-danger">Annuler</a>
