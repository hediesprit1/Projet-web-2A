...
<div class="container section-title" data-aos="fade-up">
  <h2>Nos voitures</h2>
  <p>Vous trouvez si dessous la liste de nos voitures</p>
    ...
    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
      <div class="team-member">
        <div class="member-img">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRIN5ls2-sG1Q7hn6GFpnSIHGS_GRd4Q4Gp5Q&s" class="img-fluid" alt="">
          <div class="social">
        ...
        <div class="member-info">
          <h4><?= htmlspecialchars($vehicule['marque']) ?></h4>
          <span><?= htmlspecialchars($vehicule['modele']) ?></span>
          <span>Type :<?= htmlspecialchars($vehicule['type']) ?></span>
        </div>
      </div>
    </div><!-- End Team Member -->
  <?php endforeach; ?>
