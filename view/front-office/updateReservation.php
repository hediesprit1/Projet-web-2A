...
// Optional: Get offre ID from URL
$id = isset($_GET['update']) ? intval($_GET['update']) : null;

$reservation = $reservationC->findone($id);
      ...
      <div class="container">
        <div class="row justify-content-center" data-aos="zoom-out">
          <div class="col-xl-7 col-lg-9 text-center">
            ...
            <p>Modifier la date d'une reservation</p>
          </div>
        </div>
        <div class="row gy-4 mt-5">
          ...
          <form method="post" onsubmit="return validateForm(event);" class="p-4 border rounded shadow-sm bg-light" style="max-width: 500px; margin: auto;">
            <div class="mb-3">
              ...
              <input type="date" name="date_reservation" id="date_reservation" value="<?= $reservation['date_reservation'] ?>" class="form-control" required>
            </div>
