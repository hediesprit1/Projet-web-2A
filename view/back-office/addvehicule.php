...
if (
  ...
  if (
    ...
    !empty($_POST["modele"]) &&
    !empty($_POST["marque"]) &&
    !empty($_POST["typevehicule_id"]) &&
    is_numeric($_POST["typevehicule_id"]) // Server-side check
  ) {
            ...
            document.addEventListener("DOMContentLoaded", function() {
              ...
              form.addEventListener("submit", function(e) {
                ...
                if (matricule.value.trim() === "") {
                  document.getElementById("matriculeError").textContent = "Le matricule est requis.";
                  valid = false;
                } else {
                  document.getElementById("matriculeError").textContent = "";
                }

                // Couleur: required and must NOT contain numbers
                const couleurVal = couleur.value.trim();
                if (couleurVal === "") {
                  document.getElementById("couleurError").textContent = "La couleur est requise.";
                  valid = false;
                } else if (/\d/.test(couleurVal)) {
                  document.getElementById("couleurError").textContent = "La couleur ne doit pas contenir de chiffres.";
                  valid = false;
                } else {
                ...
                if (modele.value.trim() === "") {
                  document.getElementById("modeleError").textContent = "Le modèle est requis.";
                  valid = false;
                } else {
                ...
                if (marque.value.trim() === "") {
                  document.getElementById("marqueError").textContent = "La marque est requise.";
                  valid = false;
                } else {
                  document.getElementById("marqueError").textContent = "";
                }

                // TypeVehicule ID: required and numeric
                if (typevehicule_id.value.trim() === "") {
                  document.getElementById("typeIdError").textContent = "L'ID du type de véhicule est requis.";
                  valid = false;
                } else if (!/^\d+$/.test(typevehicule_id.value.trim())) {
                  document.getElementById("typeIdError").textContent = "L'ID du type de véhicule doit être un nombre.";
                  valid = false;
                } else {
