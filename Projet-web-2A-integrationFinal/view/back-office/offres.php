    ...
    <div class="main-panel">
      ...
      <div class="container">
        <div class="page-inner">
                      ...
                      <tbody>
                        <?php foreach ($offres as $o): ?>
                          <tr>
                            ...
                            <td><?= $o['id_vehicule'] ?></td>
                            <td><?= $o['dispo'] ? 'Disponible' : 'Indisponible' ?></td>
                            <td><?= $o['prix'] ?> €</td>
                            <td>
                              <a href="?delete=<?= $o['id'] ?>" onclick="return confirm('Supprimer cette offre ?');">Supprimer</a> ||
                              <a href="updateoffre.php?update=<?= $o['id'] ?>">Modifier</a>
                            </td>
                          </tr>
                        <?php endforeach; ?>
                      </tbody>
          ...
          <a href="addoffre.php" class="btn btn-success">Créer Offre</a>
        </div>
      </div>
    </div>
