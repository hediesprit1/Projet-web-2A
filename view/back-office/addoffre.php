...
if (
  ...
  if (
    ...
    $dispo = ($_POST["dispo"] == "1") ? 1 : 0;
    $prix = floatval($_POST["prix"]);

    // Create offre instance and save
    $offre = new Offre($id_vehicule, $dispo, $prix);
    $offreC->create($offre);
  } else {
        ...
        <div class="page-inner">
            ...
            <div class="card card-round">
              <div class="card-header">
                <div class="card-head-row card-tools-still-right">
                  <div class="card-title">Ajouter un offre</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <form id="offreForm" method="post">
            <div class="mb-3">
              ...
              <input type="number" class="form-control" id="id_vehicule" name="id_vehicule">
