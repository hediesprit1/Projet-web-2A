        ...
        <div class="page-inner">
          ...
          <script>
            document.addEventListener("DOMContentLoaded", function() {
              ...
              form.addEventListener("submit", function(e) {
                ...
                if (title.value.trim() === "") {
                  document.getElementById("titleError").textContent = "Titre requis.";
                  valid = false;
                } else {
                ...
                if (content.value.trim() === "") {
                  document.getElementById("contentError").textContent = "Contenu requis.";
                  valid = false;
                } else {
          ...
          <form id="blogForm" method="post">
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control" id="content" name="content" rows="5"><?= htmlspecialchars($blog['content']) ?></textarea>
              <span id="contentError" style="color:red;"></span>
            </div>

            <div class="mb-3">
              <label class="form-label">ID Catégorie :</label>
              <input type="number" class="form-control" id="category_id" name="category_id" value="<?= $blog['category_id'] ?>">
            </div>
