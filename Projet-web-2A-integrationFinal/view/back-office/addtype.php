...
if (
  ...
  if (
    ...
    // Create new TypeVehicule object
    $typeVehicule = new TypeVehicule($type, $capacite, $categorie);

    // Call create method from the controller to insert into the database
    $typeVehiculeC->create($typeVehicule);
  } else {
      ...
      <div class="container">
        <div class="page-inner">
          <div
            ...
            <div>
              <h3 class="fw-bold mb-3">Gestion des categories</h3>
            </div>
          ...
          <script>
            document.addEventListener("DOMContentLoaded", function() {
              let form = document.getElementById("typeVehiculeForm");
          ...
          <form id="typeVehiculeForm" method="post">
            ...
            <a href="types.php" class="btn btn-danger">Annuler</a>
            <button type="submit" class="btn btn-primary">Ajouter le Type de Véhicule</button>
          </form>
        </div>
      </div>
    </div>
