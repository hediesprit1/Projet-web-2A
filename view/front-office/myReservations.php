...
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
  $_GET['delete'] = intval($_GET['delete']); // Sanitize input
  $reservationC->delete($_GET['delete']);    // Pass ID to delete()
      ...
      <div class="container">
        <div class="row justify-content-center" data-aos="zoom-out">
          <div class="col-xl-7 col-lg-9 text-center">
            ...
            <p>Consulter la liste de mes reservations</p>
          </div>
        </div>
              ...
              <?php if (!empty($reservations)): ?>
                <?php foreach ($reservations as $r): ?>
                  <tr>
                    ...
                    <td>
                      <a href="?delete=<?= $r['id'] ?>" onclick="return confirm('Annuler cette réservation ?');" class="text-danger">Annuler</a>
                      || <a href="updateReservation.php?update=<?= $r['id'] ?>">Modifier</a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              <?php else: ?>
